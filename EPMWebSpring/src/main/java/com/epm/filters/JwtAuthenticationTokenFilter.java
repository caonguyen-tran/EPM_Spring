...
public class JwtAuthenticationTokenFilter extends UsernamePasswordAuthenticationFilter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (jwtService.validateTokenLogin(authToken)) {
            ...
            AccountStudent accountStudent = accountStudentService.findByUsername(username);
            if (accountStudent != null) {
                ...
                UserDetails userDetail = new org.springframework.security.core.userdetails.User(username, accountStudent.getPassword(), enabled, accountNonExpired,
